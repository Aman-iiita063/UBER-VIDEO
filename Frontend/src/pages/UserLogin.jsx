  ...
  return (
    <div className="px-5 py-5 flex flex-col justify-between h-screen">
      ...
      <div>
        <Link
          to="/captain-login"
          className="bg-[#10b461] flex items-center justify-center text-white font-semibold mb-5 rounded px-4 py-2 w-full text-lg placw-holder:text-base"
        >
          Sign in as Captain
        </Link>
      </div>
